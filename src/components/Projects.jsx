              ...
              <Box mt='10%'>
                     ...
                     <Grid p='25px' boxShadow='   #02054B 0px 5px 15px;' gap='7' gridTemplateColumns={{ base: 'repeat(1,1fr)', md: 'repeat(1,1fr)', lg: 'repeat(2,1fr)' }} >
                            <Box>
                                   ...
                                   <Box gap='2' display='flex' m='auto' >
                                          <Box>
                                                 <Link href='https://github.com/hustler-abhi/busy-motion-6100' ><Button _hover={{ bg: '#02054B' }} color='white' backgroundColor='#F60A68'>CODE</Button></Link>
                                          </Box>
                                          <Box>
                                                 <Link href={'https://lambent-paprenjak-947e76.netlify.app/'}> <Button _hover={{ bg: '#02054B' }} color='white' backgroundColor='#F60A68'>LIVE</Button></Link>
                                          </Box>
                     ...
                     <Grid mt='2%' p='25px' boxShadow='   #02054B 0px 5px 15px;' gap='7' gridTemplateColumns={{ base: 'repeat(1,1fr)', md: 'repeat(1,1fr)', lg: 'repeat(2,1fr)' }} >
                            <Box>
                                   ...
                                   <Box gap='2' display='flex' m='auto' >
                                          <Box> <Link href='https://github.com/gaurav62472744/halting-title-3346'><Button _hover={{ bg: '#02054B' }} color='white' backgroundColor='#F60A68'>CODE</Button></Link></Box>
                                          <Box> <Link href='https://halting-title-3346.vercel.app/'> <Button _hover={{ bg: '#02054B' }} color='white' backgroundColor='#F60A68'>LIVE</Button></Link></Box>
                     ...
                     <Grid mt='2%' p='25px' boxShadow='   #02054B 0px 5px 15px;' gap='7' gridTemplateColumns={{ base: 'repeat(1,1fr)', md: 'repeat(1,1fr)', lg: 'repeat(2,1fr)' }} >
                            <Box>
                                   ...
                                   <Box gap='2' display='flex' m='auto' >
                                          <Box> <Link href='https://github.com/jitendra4545/-tedious-advertisement-2369'><Button _hover={{ bg: '#02054B' }} color='white' backgroundColor='#F60A68'>CODE</Button></Link></Box>
                                          <Box> <Link href='https://fancy-queijadas-c9c9f4.netlify.app/'> <Button _hover={{ bg: '#02054B' }} color='white' backgroundColor='#F60A68'>LIVE</Button></Link></Box>
                     ...
                     <Grid mt='2%' p='25px' boxShadow='   #02054B 0px 5px 15px;' gap='7' gridTemplateColumns={{ base: 'repeat(1,1fr)', md: 'repeat(1,1fr)', lg: 'repeat(2,1fr)' }} >
                            <Box>
                                   ...
                                   <Box gap='2' display='flex' m='auto' >
                                          <Box> <Link href='https://github.com/anwarjitme/green-room-4314/tree/main'><Button _hover={{ bg: '#02054B' }} color='white' backgroundColor='#F60A68'>CODE</Button></Link></Box>
                                          <Box> <Link href='https://subtle-semifreddo-ade928.netlify.app/'> <Button _hover={{ bg: '#02054B' }} color='white' backgroundColor='#F60A68'>LIVE</Button></Link></Box>
