...
function AboutMe() {
    return (
        <Box mt='10%' >
            <Heading mb='5%' color='#02054B' transition='step-start' textAlign='left' as='h2' size='2xl'>About</Heading>
            <SimpleGrid gap="30" columns={{ base: '1', md: '1', lg: '2' }}>
                ...
                <Box  >
                    <Text mt='3%' w='100%' textAlign='left' lineHeight='30px' fontSize='2xl' color='black' >
