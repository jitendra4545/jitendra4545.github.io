          ...
          <Box  >
            <Tabs color={'blue'} variant='solid-rounded'>
              <TabList gap='3' >
                ...
                <Link smooth to='#contact'><Tab color={isscroll ? 'white' : "#02054B"} >Contact</Tab></Link>
          ...
          <Box  >
            <Menu >
              ...
              <MenuList fontSize='20px' fontWeight={'bold'} backgroundColor={'blue'}>
                ...
                <Link smooth to='#contact'> <MenuItem _focus={{ background: 'blue', color: "white" }}>Contact</MenuItem></Link>
